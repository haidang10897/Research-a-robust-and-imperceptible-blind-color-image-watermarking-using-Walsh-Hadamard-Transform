function AttackedWatermarkedImage = brightenAtk(WatermarkedImagePath, value)
% ______             ______            
% | ___ \            |  _  \           
% | |_/ / __ _  ___  | | | |__ _ _   _ 
% | ___ \/ _` |/ __| | | | / _` | | | |
...
%        Value to brighten
% Output: Matrices of attacked image that have been brighten

% Doc file anh
I = imread(WatermarkedImagePath);

% Attack
AttackedWatermarkedImage = I + value;
end
